...
//
// public class PathScript extends VerdiScript {
...
//         BlockPos toPos = VerdiUtil.getTargetedBlock(64);
//         if (toPos == null) return;
//
//         VerdiShell.print(String.format(
...
//             Vec2 forward = VerdiMath.getAngle(nextV3, player.position());
